...
class KruegerJobDetailForm(forms.ModelForm):
    class Meta:
        ...
        fields = [
            ...
            'step_insert_frontback_cover_price', 'step_set_to_drill_price', 'step_set_to_staple_price', 'staple_price_per_staple', 'staple_staples_per_piece', 'staple_number_of_pieces', 
            ...
            'step_delivery_price', 'step_packing_slip_price', 'price_total', 'price_total_per_m'
        ]
        widgets = {
